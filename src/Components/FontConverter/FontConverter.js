...
function FontConverter() {
    ...
    const generateJpeg = () => {
        domtoimage.toJpeg(document.getElementById('page'), {
            ...
            width: window.innerWidth * 1.1,  // Optional: upscale resolution for better quality
            height: window.innerHeight * 1.1  // Optional: upscale resolution for better quality
        })
            ...
            <div className="fontStyler">
                ...
                <div className="gridOne">
                    <div className="fontFamily" style={{marginBottom: "1.5rem"}}>
                            ...
                            <InputLabel id="font-label">Shriftlar</InputLabel>
                            <Select
                                    labelId="font-label"
                        ...
                        <div className="fontSize" style={{marginBottom: "1.5rem"}}>
                            <FormControl style={{minWidth: 150}}>
                                <InputLabel id="fontSize-label" >Matn kattaligi</InputLabel>
                                <Select
                                value={fontSize}
                            ...
                            <div className="fontWeight" style={{marginBottom: "1.5rem"}}>
                                <InputLabel id="fontWeight">Matn qalinligi</InputLabel>
                            ...
                            <div className="letterSpacing" style={{marginBottom: "1.5rem"}}>
                                <FormControl style={{minWidth: 150}}>
                                    <InputLabel id="letterSpacing-label">Harflar yaqinligi</InputLabel>
                                    <Select
                                    value={letterSpacing}
                            ...
                            <div className="wordSpacing" style={{marginBottom: "1.5rem"}}>
                                <FormControl style={{minWidth: 150}}>
                                    <InputLabel id="wordSpacing-label">So'zlar yaqinligi</InputLabel>
                                    <Select
                                    value={wordSpacing}
                        ...
                        <div className="gridTwo">
                            <div className="colorButton">
                                <Button style={{backgroundColor: `${color}`}} onClick={() => setShowColorPicker1(showColorPicker => !showColorPicker)} variant="contained" color="primary">
                                    {showColorPicker1 ? 'Yopish ' : 'Matn rangi'}
                                </Button>
                            </div>
                            ...
                            <div className="colorButton">
                                <Button style={{backgroundColor: `${pageColor}`, color: 'black'}} onClick={() => setShowColorPicker2(showColorPicker => !showColorPicker)} variant="contained" color="primary">
                                    {showColorPicker2 ? 'Yopish ' : 'Varoq rangi'}
                                </Button>
                            </div>
                            <div className="colorPicker">
                                {
                        ...
                        <div className="gridThree">
                            <div className="lineHeight" style={{marginBottom: "1.5rem"}}>
                                <InputLabel id="lineHeight">Qator uzunligi</InputLabel>
                                <Slider style={{width: 150}}
                                    defaultValue={30}
                                    value={lineHeight}
                                    aria-labelledby="discrete-slider"
                            ...
                            <div className="linesCheckbox">
                                <Tooltip title="Chiziqlar qo'shish" placement="right" TransitionComponent={Fade} arrow>
                                    <FormControlLabel
                                        control={<Switch checked={line} onChange={handlePageLines} name="lines" color="primary"/>}
                                        label="Varoq chiziqlari"
                                    />
                                </Tooltip>
                            </div>

                            <div className="shadowCheckbox">
                                <Tooltip title="Soyalar qo'shish" placement="left" TransitionComponent={Fade} arrow>
                                    <FormControlLabel
